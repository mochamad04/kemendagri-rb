        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-pencil"></i> <span> Berta</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
                ...
                // if($cek==1 OR $this->session->level=='admin'){
                //   echo "<li><a href='".base_url().$this->uri->segment(1)."/album'><i class='fa fa-circle-o'></i> Kementrian Lembaga</a></li>";
                // }

                $cek=$this->model_app->umenu_akses("gallery",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/gallery'><i class='fa fa-circle-o'></i> Kementrian Lembaga</a></li>";
                }
              ?>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-play"></i> <span> Video</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-blackboard"></i> <span> Informasi </span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
                $cek=$this->model_app->umenu_akses("iklanatas",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/iklanatas'><i class='fa fa-circle-o'></i> Slide </a></li>";
                }
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/banner'><i class='fa fa-circle-o'></i> Important Link</a></li>";
                }
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-blackboard"></i> <span> Interaksi</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
