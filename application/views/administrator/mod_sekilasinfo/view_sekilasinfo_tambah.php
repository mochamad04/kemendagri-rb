          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    <input type='hidden' name='id' value=''>
                      <tr><th scope='row' width='120px'> Judul</th>             <td><input type='text' class='form-control' name='sub_judul'  required> </td></tr>
                    <tr><th scope='row' width='120px'>Tulis Info</th>             <td><textarea class='form-control' name='a' style='height:400px' required></textarea></td></tr>
