    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Sub Judul</th>    <td><input type='text' class='form-control' name='sub_judul'  required></td></tr>
                    <tr><th width='120px' scope='row'>Isi</th>    <td><textarea class='form-control' name='isi' ></textarea></td></tr>
                    <tr><th width='120px' scope='row'>Url</th>    <td><input type='url' class='form-control' name='b' required></td></tr>
                    <tr><th width='120px' scope='row'>Text Url</th>    <td><input type='text' class='form-control' name='text_url' required></td></tr>
